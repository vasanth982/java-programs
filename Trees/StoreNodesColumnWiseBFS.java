...
class StoreNodesColumnWiseBFS {
 
 
public static void storeColumnWise(TreeNode root){
if(root==null)
return;
 
// HashMap: column -> list of node values
...
System.out.println("Column-wise storage");
storeColumnWise(root);
}
}